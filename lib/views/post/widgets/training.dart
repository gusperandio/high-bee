      ...
      child: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/images/marcadagua.png',
              ...
              BulletPoint(
                text: 'Como é exibido títulos',
                sizeFont: 18,
              ),
              BulletPoint(
                text: 'Como é exibido a capa',
                sizeFont: 18,
              ),
              BulletPoint(
                text: 'Como fornecer o conteúdo',
                sizeFont: 18,
              ),
              BulletPoint(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Separator(
                  color: Colors.black,
                  content: const Text("Ou tentar digitar",
                      style: TextStyle(
                          fontSize: 15,
                          fontFamily: 'Urbanist',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 15),
              Text(
                "Escolha o tipo de fonte para trazer aquele AR para seu conteúdo",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontSize: 16,
                    color: PrimaryColors.carvaoColor,
                  ...
                  children: [
                    if (_currentIndex > 0)
                      ButtonCircle.black(
                        ...
                        content: SvgPicture.asset('assets/svg/chevron-left.svg',
